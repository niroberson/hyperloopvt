...
At = (8.5/1000)^2*pi; % 3/4 in pipe      % OPTIMIZE
            
%% Propellant - Nitrogen

T_min = 77;    % MINIMUM CONSTRAINT
k = 1.4;
R = 297;
...
% PROPELLANT LEFT IN TANK IS CONSTRAINT
t_crit = 0;
...
Fth = @(t) Ve(t).*mdot(t) + (Pe(t) - Pvac)*Ae;   % CRITICAL PLOT
