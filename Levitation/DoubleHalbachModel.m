...
C1 = (2*B*R2 - 2*D*R2*R3 + A*R2*a - A*R3*a + A*R2*b + A*R3*b - C*R2^2*a...
      + C*R2^2*b + C*R2*R3*a + C*R2*R3*b)/(R2^2*b - R2^2*a + R1*R2*a...
      - R1*R3*a + R2*R3*a + R1*R2*b + R1*R3*b + R2*R3*b);
  
C2 = -(B*R1 - B*R2 - D*R1*R3 + D*R2*R3 - A*R2*b - A*R3*b + C*R1*R2*b...
     + C*R1*R3*b)/(R2^2*b - R2^2*a + R1*R2*a - R1*R3*a + R2*R3*a...
     + R1*R2*b + R1*R3*b + R2*R3*b);
 
C3 = (B*R1 + B*R2 - D*R1*R3 - D*R2*R3 + A*R2*a - A*R3*a - C*R1*R2*a...
     + C*R1*R3*a)/(R2^2*b - R2^2*a + R1*R2*a - R1*R3*a + R2*R3*a...
     + R1*R2*b + R1*R3*b + R2*R3*b);

C4 = (B*R2*a - B*R1*a + B*R1*b + B*R2*b - D*R2^2*a + D*R2^2*b...
